...
#'
#' @description Compute the two sided interval estimation of \code{mu} of one non-normal sample with large sample size when the population variance is known or unknown.
#'
